...
public class CaptureActivity extends Activity implements View.OnClickListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mDraw = new DrawCaptureRect(CaptureActivity.this, getResources().getColor(R.color.face_rect));// 添加人脸框
        initView();
    }
...
//        btnCamera = (Button) this.findViewById(R.id.btnCamera);
        ...
        mScreenWidth = currDisplay.getWidth();//屏幕大小
        mScreenHeight = currDisplay.getHeight();
    ...
    void setFaceQuality() {
        ...
        if (1 == quality) {
            iFaceSize = mScreenWidth * 6 / 30;//屏幕大小*6/30  为1/5
        } else if (2 == quality) {
            iFaceSize = mScreenWidth * 10 / 30;
        } else {
            iFaceSize = mScreenWidth * 8 / 30;
        }
    }
        ...
        try {
            if (!isPreview) {
                ...
                if (camera != null) {
                    ...
                    // 设置分辨率  （获取相机分辨率）
                    List<Camera.Size> parametersList = parameters.getSupportedPreviewSizes();
                    //迭代器
                    Iterator<Camera.Size> its = parametersList.iterator();
//                    int minWidth = 0;
...
//	                width=width-(iWith*1/8)*2;
    ...
    public void OtherSetPage(View v) {
        ...
        intent.setClass(CaptureActivity.this, OtherSetActivity.class);
            ...
            switch (msg.what) {
                case 0:
                    ...
                    if (FaceNative.getCompareFlag() == 1) {
                        Intent intent = new Intent(CaptureActivity.this, ShowSuccessActivity.class);
                        startActivityForResult(intent, 1);
                        break;
                    }
                    Intent intent = new Intent(CaptureActivity.this, ShowFailActivity.class);
                    startActivityForResult(intent, 1);
                    break;
                case 1:
                    Intent intent1 = new Intent(CaptureActivity.this, ShowSuccessActivity.class);
                    startActivityForResult(intent1, 1);
                    break;
                case 2:
                    Intent intent11 = new Intent(CaptureActivity.this, ShowFailActivity.class);
            ...
            if (1 == FaceNative.getPictureFaceFlag())//获取人脸正确， 正面人脸
            {
                try {
                    ...
                    if (p.isZoomSupported())//当中要想设置其焦距必须对其进行检查，只有2.2或者之后的才支持
                    {
                        ...
                        } else if (fp.getmREX() - fp.getmLEX() > mScreenWidth / 2)//两眼之间的间距>一半的屏幕
                        {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case R.id.action_login : {
            ...
            case R.id.action_setsvrip: {
                Intent intent = new Intent(CaptureActivity.this, SetServerIPActivity.class);
                startActivity(intent);
                break;
            }
            case R.id.action_showlist: {
                Intent intent = new Intent(CaptureActivity.this, ShowRecordListActivity.class);
                startActivity(intent);
                break;
            }
            case R.id.action_setting: {
                Intent intent = new Intent(CaptureActivity.this, SettingActivity.class);
                startActivity(intent);
                break;
            }
...
//        initCamera();
    ...
    private void getDiaLog() {
        ...
        startActivity(intent);
//		AlertDialog.Builder builder = new AlertDialog.Builder(CaptureActivity.this,R.style.SampleThemeLight);//R.style.SampleThemeLight
//		View view = LayoutInflater.from(CaptureActivity.this).inflate(R.layout.activity_new_setting_page, null);
