    ...
    private void drawDownOrSelectedBg(Canvas canvas) {  
        ...
        if (!selectedEndDate.before(showFirstDate)  
            ...
            for (int i = section[0]; i <= section[1]; i++) {  
                ...
                drawCellText(canvas, i, date[i] + "", Color.BLACK);
...
//              }  
    ...
    private class Surface {  
        ...
        public int bgColor = Color.parseColor("#105E8F"); //背景色 
        ...
        private int noColor = Color.parseColor("#cccccc"); //当月日期以外的 日期颜色 
        public int todayNumberColor = Color.RED;  //今天的日期 红色
        public int cellDownColor =Color.parseColor("#CCFFFF"); 
        public int cellSelectedColor =Color.parseColor("#42b4e2"); //日期按下的颜色   //Color.WHITE
       ...
       // public String[] weekText = { "Sun","Mon", "Tue", "Wed", "Thu", "Fri", "Sat"};  
        ...
        public void init() {  
            ...
            cellHeight = (height - monthHeight - weekHeight) / 10f; //ridi日期方框高度 值越小高越大  
            cellWidth = width / 16.2f;  //ridi日期方框宽度 值越小宽越大 
            ...
            float textSize = cellHeight * 0.1f; //ridi字体大小 
            ...
            float cellTextSize = cellHeight * 0.4f; //0.5 ridi日历中的字体大小   值大 字大
